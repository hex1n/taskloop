...
import { mutateCurrentGitTask, openCurrentGitTask, queryCurrentGit, recordCurrentGitHook, recoverCurrentGitAttachment, forkCurrentGitIdentity, stageCurrentGitTask, commitCurrentGitTask } from "./git-authority-provider.mjs";
