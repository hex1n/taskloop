...
function assertCurrentAuthorityProjection(value) {
  ...
  currentAuthorityRequire(value.authority_state_schema_version === 1 && isUuidV4(value.authority_id) && new Set(["git_common", "filesystem_detached"]).has(value.provider) && v3Integer(value.authority_sequence, 1), "projection identity");
